...
<div class="panel-heading">
   <h6 class="panel-title">Add Notification</h6>
		 ...
		 <div class="col-md-4">
		  ...
		  <div class="row">
			  <div class="col-md-2 col-md-offset-5"><br>
				 <input type="submit" name="addnotification" value="Add" class="btn btn-primary active" style="width:80%;" title="Submit Form">
			  </div>
		   </div>
	    </fieldset>
    </form>
